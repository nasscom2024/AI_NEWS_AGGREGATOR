...
[
    ...
    "https://www.youtube.com/feeds/videos.xml?channel_id=UCBPRJjIWfyNG4X-CRbnv",
]
...
# Minimum zero-shot confidence to assign a topic
THRESHOLD = 0.5

# ————— Discord webhook —————
WEBHOOK_URL = "https://discordapp.com/api/webhooks/1376439883819651143/DYRclK6YakvIeZgRBz-rIcFH3WtkuIr0mbOQ8xZRqAg1n2-o1_eoOO7Ds_W16kwTUwbR"

if WEBHOOK_URL.startswith("<"):
    raise ValueError(
        "Discord webhook URL not set. "
        "Either export DISCORD_WEBHOOK_URL or replace the placeholder in config.py"
    )
